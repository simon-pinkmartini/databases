...
Download "project.zip" and look at "mapv2.html" to see the final result.


The files needed to display the end result in this project are:
...
The following jupyter notebooks document the work process and can be run again to refresh the data at a later stage:
...
- Descriptive Analysis.ipnyb: Queries the SQL database and generates some static charts
